        ...
        ({
            ...
            meta: [
                ...
                { 
                    hid: 'description', 
                    name: 'description', 
                    content: data.description || 'พาโตนะ ระบบจัดการร้านค้า ระบบหลังบ้านที่ใช้งานง่ายและมีประสิทธิภาพคนเดียวก็เอาอยู่!'
                },
                { 
                    hid: 'og-site_name', 
                    property: 'og:site_name', 
                    name: 'og:site_name', 
                    content: data.site_name || 'Patona'
                },
                { 
                    hid: 'og-title', 
                    property: 'og:title', 
