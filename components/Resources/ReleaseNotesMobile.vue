<template>
  <div class="container p-spacing">
    ...
    <div class="border-E5E7EB mt-4">
      ...
      <div class="bg-FFFFFF99 p-3 pe-0">
        <div v-for="(release, index) in filteredReleases" :key="index">
          ...
          <div class="row mb-2">
            <div class="col-12 d-flex pe-0">
              <div class="w-4"></div>
              <div class="w-96">
                <p class="text-s-24 font-md color-6B7280 pb-2">
                  เดือนที่มีการอัพเดต
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div class="col-12 d-flex pe-0">
              ...
              <div class="w-96">
                ...
                <span class="text-s-20 font-md color-#1F2937 mb-0 ms-3 border-text">{{
